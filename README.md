...
<head>
    ...
    <title>Kelma Delícias Caseiras</title>
    <style>
...
<body>
    ...
    <div class="hero">
        <h1>Bem-vindo à Kelma Delícias Caseiras</h1>
        <p>As melhores delícias caseiras de Juazeiro do Norte</p>
    </div>
    <div class="section">
        <h2>Sobre Nós</h2>
    ...
    <footer>
        <p>&copy; 2024 Kelma Delícias Caseiras. Todos os direitos reservados.</p>
    </footer>
</body>
</html>
